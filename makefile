...
CFLAGS=-DCPU_MKL46Z256VLL4 -I./include/ -I./src/include/ -g3 -Og -Wall -ffunction-sections
LDFLAGS= -g3 -Og --specs=nano.specs -Wl,--gc-sections,-Map,$(TARGET).map,-Tlink.ld -ffunction-sections
